...
internal class RabbitMqIntegrationEventPublisher : IIntegrationEventPublisher, IAsyncDisposable
{
    ...
    {
        if (type == typeof(InventoryReservedIntegrationEvent).FullName)
            return "inventory.reservation.succeeded";
